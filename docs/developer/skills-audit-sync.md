...
Proxy routes (high level): `GET /api/skills` (owner search, filtered to `betsalel-williamson/mdcp`), `GET /api/audit/{skill}` (per-skill audit payload). Details in [ADR 0005](../features/adr/0005-skills-audit-oidc-proxy.md).
