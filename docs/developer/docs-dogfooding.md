...
- **Vale `MDCP` / `MDCP-Xref`** — prose: unlinked numbered heading mentions; dogfood: remove Pandoc [xref](../glossary/xref.md) markers. Not `mdcp check` core steps — enable with `--require-vale`
