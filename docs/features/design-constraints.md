...
Standard Markdown / [GitHub Flavored Markdown (GFM)](../glossary/index.md#gfm) only. No Pandoc, LaTeX, wikilinks.
...
**Not the same as compile hooks:** per-shard hooks ([`guides[].compile.hooks`](../client-core/compile-hooks/index.md)) rewrite link targets, inline captioned inserts, and apply documentation-specific assembly — they are not a general template language. Custom hooks transform [authored GFM](../glossary/index.md#gfm); they do not evaluate variables or branch on runtime context.
