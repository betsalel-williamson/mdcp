...
docs until review instead of destructive overwrite.
...
3. Preserves brownfield legacy files (archive banners only — no auto-delete)
4. Passes `mdcp check` (and repo docs validation)
5. Hands off clearly to feature-level, doc-only, design-architecture, or UX
