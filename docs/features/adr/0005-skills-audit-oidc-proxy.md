...
- In-flight Issue updates and classification stay in GitHub Actions / scripts in this repo — not in the proxy. The accepted-risks log is a committed repo file read by sync.
