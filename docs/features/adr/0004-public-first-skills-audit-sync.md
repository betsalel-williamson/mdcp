...
- Delivery tracker: GitHub Issues on `betsalel-williamson/mdcp` (see [ADR 0006](./0006-rolling-skill-security-issues.md)).
...
- Maintainers triage public audit findings from rolling GitHub Issues rather than only from skills.sh UI.
