...
Paths: [CLI README](../../packages/mdcp-cli/README.md), [getting-started helper skill](../../skills/mdcp-getting-started/SKILL.md), [usage model](./protocol/usage-model.md), [vision](./protocol/00-vision-and-roadmap.md), [claims policy](./protocol/benefit-claims-and-evidence.md).
