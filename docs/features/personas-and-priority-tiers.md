...
Paths: [CLI README](../../packages/mdcp-cli/README.md), [getting started prompt](../../skills/mdcp/agents/getting-started.md), [usage model](./protocol/usage-model.md), [vision](./protocol/00-vision-and-roadmap.md), [claims policy](./protocol/benefit-claims-and-evidence.md).
