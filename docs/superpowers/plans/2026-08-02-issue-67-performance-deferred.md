# Issue #67: Performance deferred P2+ roadmap — Implementation Plan

> **For agentic workers:** REQUIRED SUB-SKILL: Use superpowers:subagent-driven-development (recommended) or superpowers:executing-plans to implement this plan task-by-task.

**Goal:** Deliver GitHub [#67](https://github.com/betsalel-williamson/mdcp/issues/67) per acceptance criteria.
...
| Plan file | `docs/superpowers/plans/2026-08-02-issue-67-performance-deferred.md` |

## Atomic commit groups

| Id | Concern | Files | Commit subject |
| --- | --- | --- | --- |
| gate-doc | Gate criteria and unblock checklist only | `docs/superpowers/plans/2026-08-02-issue-67-performance-deferred.md` | `docs(plan): gate monitor for #67` |
...
- [ ] List `blocked_until` issues: ["200-shard real multi-guide fixture misses Tier 1 or Tier 2 SLO","refs lookup exceeds 200ms at 500 shards","product commitment to 500-shard programs"]
