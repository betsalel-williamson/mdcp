# Issue #169: Revisit TypeScript 7 upgrade — Implementation Plan

> **For agentic workers:** REQUIRED SUB-SKILL: Use superpowers:subagent-driven-development (recommended) or superpowers:executing-plans to implement this plan task-by-task.

**Goal:** Deliver GitHub [#169](https://github.com/betsalel-williamson/mdcp/issues/169) per acceptance criteria.
...
| Plan file | `docs/superpowers/plans/2026-08-02-issue-169-typescript-7.md` |

## Atomic commit groups

| Id | Concern | Files | Commit subject |
| --- | --- | --- | --- |
| gate-doc | Gate criteria and unblock checklist only | `docs/superpowers/plans/2026-08-02-issue-169-typescript-7.md` | `docs(plan): gate monitor for #169` |
...
- [ ] List `blocked_until` issues: ["typescript-eslint TS7 support"]
