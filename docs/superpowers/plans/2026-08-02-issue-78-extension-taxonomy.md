# Issue #78: Extension taxonomy arch-*, format-* — Implementation Plan

> **For agentic workers:** REQUIRED SUB-SKILL: Use superpowers:subagent-driven-development (recommended) or superpowers:executing-plans to implement this plan task-by-task.

**Goal:** Deliver GitHub [#78](https://github.com/betsalel-williamson/mdcp/issues/78) per acceptance criteria.

**Architecture:** Extension catalog naming and manifest conventions for arch-*/format-* packs.
...
| Plan file | `docs/superpowers/plans/2026-08-02-issue-78-extension-taxonomy.md` |

## Atomic commit groups

| Id | Concern | Files | Commit subject |
| --- | --- | --- | --- |
| design | Design shard or spec section | `docs/features/` shards per helper | `docs: design for #78` |
| impl | Implementation and tests | per issue acceptance criteria | `feat: deliver #78` |
