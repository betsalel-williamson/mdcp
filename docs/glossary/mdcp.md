...
**MarkDown Context Protocol** — a **documentation system** delivered as an [Agent Skill](./agent-skills.md) and lightweight toolchain. It helps teams who care about durable docs distill mind maps, architecture notes, specs, and product ideas into small Markdown **shards** so intent stays reviewable in git, maintainable as ideas keep arriving, and readable one shard at a time by people and coding agents.
