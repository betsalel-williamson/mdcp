...
It is **not** [GFM](./gfm.md) structure. Prose static analysis (unlinked chapter-style cues, tone, spelling) belongs in peer **[Vale](https://vale.sh/) style packages**, not in durable pack rules — see [Locale and language boundary](../features/design-constraints/locale-and-language.md).
