...
Verification is split: [skill content lint](./skill-content-lint.md) (`pnpm skill:lint`) plus agentskills.io validation (`pnpm skill:validate` / skills-ref) in CI; [live skill eval](./live-skill-eval.md) is the optional local skill-creator loop.
