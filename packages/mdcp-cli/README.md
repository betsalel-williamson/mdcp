...
`WORK_ITEM_LOOKUP` should point agents at **your repo's developer docs** — not a fixed list of every tracker CLI and MCP. Each team documents its stack once during setup (see [Agent work-item tracking](#agent-work-item-tracking) in this repo).
