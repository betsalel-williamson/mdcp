...
Hard-gate branch-before-edit in parent `mdcp` QA and day-to-day helper plan steps so agents create or switch to a feature branch before editing tracked files (issue #150).
