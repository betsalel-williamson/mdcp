...
The llms-index lists all task-type prompts under `.caches/mdcp/prompts/` (populated by fetch). Source artifacts: [spec/task-prompts/](../task-prompts/). Normative table: [docs/features/protocol/agent-task-prompts.md](../../docs/features/protocol/agent-task-prompts.md).
