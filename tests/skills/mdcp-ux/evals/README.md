...
4. **Atomic commit groups (plan-only)** — multi-shard client plan under “squash / skip polish” and stay-on-main / skip-branching pressure; must name a feature branch tied to the WORK_ITEM, include numbered commit groups, and stop for review
