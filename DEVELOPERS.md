...
<!-- mdcp-shard: start docs/developer/mdcp-mcp-merge-gate.md -->
...
<!-- mdcp-shard: end docs/developer/mdcp-mcp-merge-gate.md -->
...
See [mdcp-mcp and merge gate](#mdcp-mcp-and-merge-gate) for CI wiring and upstream MCP maintainer skills.
