...
Copy-paste prompts for coding agents working with mdcp. Fill in the **Replace before sending** code block at the top of each file, then send the rest unchanged. Lookup examples: [work-item-tracking.md](./work-item-tracking.md).
...
| [work-item-tracking.md](./work-item-tracking.md)                           | Examples for the top-of-prompt code block (`WORK_ITEM`, `WORK_ITEM_LOOKUP`) |
