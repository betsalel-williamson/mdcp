...
Copy-paste prompts for coding agents working with mdcp. Replace placeholders per [work-item-tracking.md](./work-item-tracking.md).
...
| [work-item-tracking.md](./work-item-tracking.md)                           | Configuring Setup lines for GitHub, GitLab, Linear, Notion, Jira, or local `.work-items/` specs |
...
| [feature-level-task.prompt.md](./feature-level-task.prompt.md)             | Backend or full-stack feature work with docs-first and TDD                                      |
